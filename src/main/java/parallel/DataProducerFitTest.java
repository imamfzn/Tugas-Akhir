...
public class DataProducerFitTest implements Runnable {
	...
	public DataProducerFitTest(int workerId, BlockingQueue<FittingSet> queue, WorkerSemaphore semaphore, DatabaseHelper dbHelper, int size){
		this.queue = queue;
